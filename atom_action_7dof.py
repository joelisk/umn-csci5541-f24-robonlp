...
if __name__ == '__main__':
    import time
    # # root = rospy.get_param('VAE_DATA/root')# node_name/argsname
    # print(root)
    # WORKSPACE = os.path.join(root,"kinova_teleop/traj_ws/src/traj_gym/src/move_it/workspace.csv")
    # START_PATH = os.path.join(root,"kinova_teleop/traj_ws/src/traj_gym/src/move_it/index_start.pkl")
    # TARGET_PATH = os.path.join(root,"kinova_teleop/traj_ws/src/traj_gym/src/move_it/index_target.pkl")
    # print(WORKSPACE,START_PATH,TARGET_PATH)
    
    # device = rospy.get_param('VAE_DATA/robot_name') # node_name/argsname
    # job = int(rospy.get_param('VAE_DATA/job_asign')) # node_name/argsname
    # num_worker = int(rospy.get_param('VAE_DATA/num_worker'))# node_name/argsname
    # print(device,job,num_worker)
    # time.sleep(10)
